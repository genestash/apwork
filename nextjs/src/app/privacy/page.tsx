...
export default function Page() {
    return (
        <Block className={style.document}>
            ...
            <p>
                We respect your privacy and are committed to protecting your information. This Privacy Policy explains how we
                collect, use, and safeguard information when you visit our website.
            </p>

            <h2>1. Information We Collect</h2>
            <p>
                We do not collect personal information directly from you through forms, registrations, or account creation.
                However, we use Google Analytics to understand how visitors use our site. Google Analytics may collect:
            </p>
            <ul>
            ...
            <p>
                This information is provided to us in aggregated or anonymized form and is not used to personally identify
                individual visitors.
            </p>
            ...
            <p>
                Google Analytics uses cookies and similar technologies to collect usage data. If you prefer not to be tracked by
                Google Analytics, you can disable cookies in your browser settings.
            </p>

            <h2>4. Google Analytics</h2>
            <p>
                We use Google Analytics, a web analytics service provided by Google LLC. Google may process data in the United
                States or other countries. For details, please refer to Google{`'`}s privacy documentation.
            </p>

            <h2>5. Data Retention</h2>
            <p>
                We retain Google Analytics data for 12 months, after which it is deleted or anonymized automatically according
                to our analytics configuration.
            </p>
            ...
            <p>
                If your data is transferred outside your country (for example, to Google servers in the United States), we will
                ensure appropriate safeguards are in place in accordance with applicable law.
            </p>

            <h2>8. External Links</h2>
            <p>
                Our website may contain links to other websites. We are not responsible for the privacy practices or content of
                those external sites. We recommend reviewing the privacy policies of any third-party sites you visit.
            </p>
