...
const list: ApplicationType[] = [
    {
        id: 'crop-image',
        name: 'Crop Image',
        icon: '/applications/crop-image.webp',
...

    {
        ...
        icon: '/applications/webp-to-png-converter.webp',
        description:
    ...
    },
    {
        ...
        icon: '/applications/count-words-and-characters.webp',
    ...
    },
    {
        ...
        icon: '/applications/make-image-black-and-white.webp',
...

    {
        id: 'merge-pdf',
        name: 'Merge PDF',
        icon: '/applications/merge-pdf.webp',
    ...
    },
    {
        ...
        icon: '/applications/margin-calculator.webp',
